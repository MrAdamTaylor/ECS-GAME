...
public partial class GameEntity {
    ...
    public Code.Gameplay.TargetCollection.CollectTargetInterval collectTargetInterval { get { return (Code.Gameplay.TargetCollection.CollectTargetInterval)GetComponent(GameComponentsLookup.CollectTargetInterval); } }
    ...
    public GameEntity AddCollectTargetInterval(float newValue) {
        ...
        var component = (Code.Gameplay.TargetCollection.CollectTargetInterval)CreateComponent(index, typeof(Code.Gameplay.TargetCollection.CollectTargetInterval));
