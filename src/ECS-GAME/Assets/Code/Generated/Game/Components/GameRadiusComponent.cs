...
public partial class GameEntity {
    ...
    public Code.Gameplay.TargetCollection.Radius radius { get { return (Code.Gameplay.TargetCollection.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (Code.Gameplay.TargetCollection.Radius)CreateComponent(index, typeof(Code.Gameplay.TargetCollection.Radius));
